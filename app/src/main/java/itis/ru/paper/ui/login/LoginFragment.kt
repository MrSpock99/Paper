package itis.ru.paper.ui.login
...
import itis.ru.paper.utils.LoginState
import itis.ru.paper.utils.ScreenState
...
class LoginFragment : BaseFragment() {
    ...
    private fun processLoginState(renderState: LoginState) {
        ...
        when (renderState) {
            LoginState.SuccessLogin -> rootActivity.navController.navigate(R.id.action_loginFragment_to_restaurantListFragment)

            LoginState.SuccessRegister -> rootActivity.navController.navigate(R.id.action_loginFragment_to_restaurantListFragment)
